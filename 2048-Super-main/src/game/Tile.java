...
public class Tile {
    ...
    private int x;
    private int y;
    private boolean beginingAnimation = true;
    private double scaleFirst = 0.1;
    private BufferedImage beginingImage;
    ...
    public Tile (int value, int x, int y) {
        ...
        beginingImage = new BufferedImage(WIDTH, HEIGHT, BufferedImage.TYPE_INT_ARGB);
    ...
    public void update() {
        if (beginingAnimation) {
            ...
            transform.translate(WIDTH / 2 - scaleFirst * WIDTH, HEIGHT / 2 - scaleFirst * HEIGHT);
            transform.scale(scaleFirst, scaleFirst);
            Graphics2D g2d = (Graphics2D) beginingImage.getGraphics();
            ...
            AffineTransform transform = new AffineTransform();
            transform.translate(WIDTH / 2 - scaleCombine * WIDTH, HEIGHT / 2 - scaleCombine * HEIGHT);
    ...
    public void render(Graphics2D g) {
        if (beginingAnimation) {
            g.drawImage(beginingImage, x, y, null);
        }
        else if (combineAnimation) {
