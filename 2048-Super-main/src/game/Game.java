...
import src.gui.GUIScreen;
import src.gui.LeaderboardsPanel;
import src.gui.MainMenuPanel;
import src.gui.PlayPanel;

public class Game extends JPanel implements KeyListener, MouseListener, MouseMotionListener, Runnable {

    private static final long serialVersionUID = 1L;
    public static final int WIDTH = GameBoard.BOARD_WIDTH + 200;
